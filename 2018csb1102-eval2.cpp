...
this is my algo but i wasn't able to build that heap though i have made both al tree and also augmented 
the second means i can simply get tmin but in time complwxity O(n).

3 function not made other functions are working properly
*/

#include<iostream>
using namespace std;
double epsn=10e-9;//to compare float values
